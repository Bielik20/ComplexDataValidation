...
namespace ComplexDataValidation.Controllers
{
    public class ParentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var parent = await _context.Parents.SingleOrDefaultAsync(m => m.ID == id);
            if (parent == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("ID,Age,Name")] Parent parent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Age,Name")] Parent parent)
        {
            if (id != parent.ID)
            {
                return NotFound();
